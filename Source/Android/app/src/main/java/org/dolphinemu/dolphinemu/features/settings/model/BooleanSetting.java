...
public enum BooleanSetting implements AbstractBooleanSetting
{
  ...
  MAIN_EXPAND_TO_CUTOUT_AREA(Settings.FILE_DOLPHIN, Settings.SECTION_INI_INTERFACE, "ExpandToCutoutArea", false),
  ...
  GFX_SHOW_ACTIVE_TITLE(Settings.FILE_GFX, Settings.SECTION_GFX_SETTINGS, "ShowActiveTitle", false),
