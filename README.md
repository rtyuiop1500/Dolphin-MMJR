...
If for some reason you prefer the old builds over the new one; you can get it on the github page and I made a backup branch of the code as well. The former builds will have their names as "Dolphin |MMJR| - 1.0-XXXXX" ... whereas all newer version will just be "Dolphin |MMJR| - XXXXX" going forward.
